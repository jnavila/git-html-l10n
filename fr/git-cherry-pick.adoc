...
-s::
--signoff::
	Ajouter une ligne terminale `Signed-off-by` au message de validation. Référez-vous à l'option de contre-signature dans linkgit:git-commit[1] pour plus d'information.
