...
Un commentaire de commit est lu à partir de stdin. Si une entrée de changelog n’est pas fournie via la redirection « < », 'git commit-tree' attendra simplement qu’une entrée soit entrée et terminée par ^D.
