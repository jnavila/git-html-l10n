...
--trailer=<ligne-terminale>::
	Ajouter la ligne terminale à chaque message de commit rebasé, traité via linkgit:git-interpret-trailers[1]. Cette option implique `--force-rebase`.
+
Voir aussi OPTIONS INCOMPATIBLES ci-dessous.
