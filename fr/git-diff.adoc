...
git diff [<options>] --no-index [--] <chemin> <chemin> [<spéc-de-chemin>...]
...
------------
+
<1> Modifications dans l'arbre de travail pas encore indexées pour le prochain commit.
