...
+
Ce mode exige que le dépôt distant soit poussé. En repoussant sur le même distant duquel vous tirez, la branche actuelle doit également avoir une branche de suivi en amont avec le même nom.
+
