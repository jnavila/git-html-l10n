...
Kommandot packar som standard alla taggar och referenser som redan är packade, och lämnar andra referenser ifred. Detta beror på att grenar förväntas utvecklas aktivt och att packa deras toppar inte förbättrar prestandan. Det här alternativet gör att alla referenser också packas, med undantag för dolda referenser, trasiga referenser och symboliska referenser. Användbart för ett kodförråd med många grenar av historiskt intresse.
...
Packa referenser efter behov beroende på referensdatabasens aktuella tillstånd. Beteendet beror på vilket referensformat som används av kodförrådet och kan ändras i framtiden.
+
