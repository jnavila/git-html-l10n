--continue::
	Fortsätt den pågående operationen med informationen i `.git/sequencer`. Kan användas för att fortsätta efter att konflikter i en misslyckad cherry-picking eller återställning har lösts.
