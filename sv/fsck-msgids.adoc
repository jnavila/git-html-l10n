...
`badParentSha1`::
	(FEL) Ett incheckningsobjekt har en ogiltig förälder sha1.
...
`missingTree`::
	(FEL) `tree`-rad saknas i ett incheckningsobjekt.
...
`nulInCommit`::
	(WARN) En NUL-byte hittades i incheckningsobjektets brödtext.
