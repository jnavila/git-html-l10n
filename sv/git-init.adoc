...
Ange det givna objektet _<format>_ (hashalgoritm) för repot. Giltiga värden är `sha1` och (om aktiverat) `sha256`. `sha1` är standardvärdet.
+
include::object-format-disclaimer.adoc[]

`--ref-format=<format>`::
Ange den givna referenslagrings-_<format>_ för repot. Giltiga värden är:
+
...
Använd _<grennamn>_ för den initiala grenen i det nyskapade arkivet. Om inget namn anges, återgå till standardnamnet
